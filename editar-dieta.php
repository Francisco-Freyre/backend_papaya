            ...
            <div class="container-fluid">
                <form action="controller/dietaController.php" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Cereales y tuberculos c/g</label>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Cereales y tuberculos s/g</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Leguminosas</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Verduras</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">POA muy bajo en grasa</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">POA bajo en grasa</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">POA moderado en grasa</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">POA alto en grasa</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Leche entera</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Leche semidescremada</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Leche descremada</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Leche con azucar</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Grasa sin proteina</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Grasa con proteina</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Azucares sin grasa</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Azucares con grasa</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Alimentos libres en energia</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="nombre">Bebidas alcoholicas</label>
                                <input type="text" class="form-control" autocomplete="off">
                                <P>Kcal = 0</P>
                                <P>HCO's = 0</P>
                                <P>P's = 0</P>
                    ...
                    <div class="row">
                        ...
                        <div class="col text-center">
                            <div class="form-group">
                                <label for="">Equivalencia kcal</label>
                                <P>Carbohidratos = 0</P>
                                <P>Proteinas = 0</P>
                                <P>Grasas = 0</P>
                            </div>
