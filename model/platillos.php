...
class platillos {
    ...
    public function getIngredientesDos($id){
        $sql = "SELECT DISTINCT ingredientes2.id, ingredientes2.equivalente, ingredientes2.cambiar, alimentos.nombre, alimentos.unidad FROM ingredientes2, alimentos WHERE ingredientes2.platillo_id = $id AND ingredientes2.alimento_id = alimentos.id";
        $response = $this->db->query($sql);
