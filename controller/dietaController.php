...
if(isset($_POST)){
    if(isset($_POST['accion'])){
        ...
        if($_POST['accion'] == 'editar-dieta'){
            ...
            if($edit){
                echo "<script>";
                echo "alert('Dieta editada correctamente');";
                echo "window.location.replace('../dietas.php');";
                echo "</script>";
            }
            else{
